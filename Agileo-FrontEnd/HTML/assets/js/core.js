$(function() {
  ...
  // MODIFICATION: Garder la rightbar fermée par défaut
  var alterClass = function() {
    var ww = document.body.clientWidth;
    // Toujours garder la rightbar fermée
  ...
  // Le bouton right_tab fonctionne normalement pour ouvrir/fermer
  $('a.right_tab').on('click', function(e) {
    e.preventDefault();
    e.stopPropagation();
  ...
  $(document).ready(function() {
    $('body').removeClass('right_tb_toggle').addClass('close_rightbar');
  });
...
$(function() {
  ...
  // right side bar - fonctionne normalement
